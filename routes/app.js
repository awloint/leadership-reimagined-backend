...
const uri = `mongodb+srv://${process.env.ATLAS_USER}:${process.env.ATLAS_PASSWORD}@main-cluster-8mekn.mongodb.net/zoom-conference-deculturing-rape?retryWrites=true&w=majority`
mongoose
