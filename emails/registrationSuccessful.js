const htmlBody = (firstName, lastName) => {
  return `<table style='background-color: #d5d5d5;' border='0' width='100%' cellspacing='0'>
        ...
        <strong>Topic:</strong> WOMEN IN THE FRONTLINE IN CRISIS TIME: RETHINKING IMPACT AND THE CHALLENGES OF LEADERSHIP.<br>
        <strong>Time:</strong> May 6, 2020 07:00 PM Nigeria (in your local time)<br>
        </p>
        <p>
        Zoom meeting link: <a href='https://zoom.us/j/94296666416?pwd=WlVBZFZTS3k2bHBvaUVxY2diQXQxUT09'>https://zoom.us/j/94296666416?pwd=WlVBZFZTS3k2bHBvaUVxY2diQXQxUT09</a> <br>
        <strong>Meeting ID:</strong> 942 9666 6416 <br>
        <strong>Password:</strong> 681839
        </p>
        <p>Best regards!</p>
        </td>
        </tr>
...
const textBody = (firstName, lastName) => {
  return `
    ...
    Topic: WOMEN IN THE FRONTLINE IN CRISIS TIME: RETHINKING IMPACT AND THE CHALLENGES OF LEADERSHIP.
    Time: May 6, 2020 07:00 PM Nigeria (in your local time)
    Zoom Meeting Link: https://zoom.us/j/94296666416?pwd=WlVBZFZTS3k2bHBvaUVxY2diQXQxUT09
    Meeting ID: 942 9666 6416
    Password: 681839
    Best regards!
    `
}
